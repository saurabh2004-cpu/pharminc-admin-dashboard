...
const AddressCreate = () => {
    ...
    return (
        <div>
            <Breadcrumb title="Create Address" items={BCrumb} />
            <Grid container spacing={3}>
                ...
                <Grid item size={{ xs: 12 }} mt={3}>
                    <Button variant="contained" color="primary" onClick={handleSubmit} disabled={loading}>
                        {loading ? <CircularProgress size={24} /> : 'Create Address'}
                    </Button>
                </Grid>
            </Grid> 
            ...
            >
                {error ? (
                    ...
                    <Alert onClose={handleCloseSnackbar} severity="success">Address created successfully!</Alert>
                )}
            </Snackbar>
        </div>
    );
